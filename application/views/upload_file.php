...
<div>2. The<strong> samples</strong> of your file should not less than 5 and the <strong>size</strong> of your file should less than 15MB,or it will cause error!</div>   
...
<script type="text/javascript">  
 $("#file-1").fileinput({
          ...
          prepareinterface(data.response['link'],data.response['filename']); 
